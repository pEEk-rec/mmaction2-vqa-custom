...
launcher = 'none'
load_from = 'D:\\Academics\\SEM-5\\NVIDIA_miniproj\\mmaction2-1\\work_dirs\\swin_tiny_finevd_mos\\epoch_30.pth'
log_level = 'INFO'
...
resume = False
resume_from = 'D:\\Academics\\SEM-5\\NVIDIA_miniproj\\mmaction2-1\\work_dirs\\swin_tiny_finevd_mos\\epoch_5.pth'
...
train_cfg = dict(
    max_epochs=60, type='EpochBasedTrainLoop', val_begin=1, val_interval=5)

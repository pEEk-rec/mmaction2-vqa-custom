ann_file_test = 'D:\\Academics\\SEM-5\\NVIDIA_miniproj\\mmaction2-1\\VQA_dataset\\Annotations\\test.json.json'
...
model = dict(
    backbone=dict(
        ...
        pretrained=
        'https://download.openmmlab.com/mmaction/v1.0/recognition/swin/swin_tiny_patch4_window7_224_1k.pth',
        pretrained2d=False,
        qk_scale=None,
        qkv_bias=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'D:\\Academics\\SEM-5\\NVIDIA_miniproj\\mmaction2-1\\VQA_dataset\\Annotations\\test.json.json',
        data_prefix=dict(
            video=
